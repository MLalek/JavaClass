...
public interface I01 {
	...
	/*
	 ...
	 2)There are 2 type of abstraction a)Partial Abstraction
	 									 If you create an abstract class, some methods
	 									 are not abstract because of that we name using
	 									 abstract classes "partial abstraction"
	 									b) Full Abstraction
	 									  In full abstraction all methods must be abstract 
	 									  If you use "interface", it must to make all methods
	 									  abstract inside an interface. Because of that using
	 									  "interfaces" is named as "Full Abstraction"
