...
public class TM01 {
	...
	/*
	 ...
	 2)TreeMap is not synchronize and not thread safe
	...
	public static void main(String[] args) {
		...
		//tm.put(null, "Woow");
		System.out.println(tm);//{15=Bad, 25=The best, 27=Good, 30=The worst, 50=Ugly}
		
		tm.put(11, null);
		tm.put(13, "null");
		System.out.println(tm);//{11=null, 13=null, 15=Bad, 25=The best, 27=Good, 30=The worst, 50=Ugly}
		
		tm.computeIfAbsent(15, k->"Pretty");//Birsey degismez eger listede varsa yoksa bunu ekler
		System.out.println(tm);//{11=null, 13=null, 15=Bad, 25=The best, 27=Good, 30=The worst, 50=Ugly}
