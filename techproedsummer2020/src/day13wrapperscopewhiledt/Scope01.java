...
public class Scope01 {
	...
	int num1 = 12;
	double dbl; //Java assign default number "0".
	...
	public static void main(String[] args) {
		/*
		 ...
		 Note:The variables created inside the class body and outside 
		      the methods are called:"Instance Variables".
		      num1 is an instance variable, num1 can be used from every where
		      inside the class.
		  2)If you create a variable ("ch" gibi) inside a method you can use it just inside 
		    that method. Inside the other methods, it cannot be used.
		  	Note: The variables created inside  method are called "Local Variables"
		  	"ch" is a lolcal variable
		  	
		  Question: What is the difference between "Instance Variable" and "Local Variable".
		  			==>Local variables must be initialized but if you want you may
		  			   not initialize instance variables.
