...
public class ForEachLoop01 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		for(int w : arr) {
			if(w%2==0) {
				System.out.println(w);//Burada 2 ve 4 u bulduruyor ve continue bu rakamlari birakmiyor
				continue;//continue sadece odd olanlari birakiyor ve asagida carpiliyor
