...
public class Set01 {
	/*
	 1)Set:In Set all elements must be unique, you cannot use repeated elements in a Set (No dublication)
	 ...
	 3)HashSet: Uses "hashing technique"	 
	 			...
	 			ordering element, it saves time for HAshSet because of that HshSet is faster than
